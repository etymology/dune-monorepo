...
( function()
{
  var catalog =
  {
    process:
    {
      ...
      getLayerZPlaneCalibration: "process.get_layer_z_plane_calibration",
      addLayerZPlaneMeasurement: "process.add_layer_z_plane_measurement",
      clearLayerZPlaneCalibration: "process.clear_layer_z_plane_calibration",
      machineGeometryGetState: "process.machine_geometry.get_state",
      machineGeometryRecordMeasurement: "process.machine_geometry.record_measurement",
      machineGeometryDeleteMeasurement: "process.machine_geometry.delete_measurement",
      ...
      vTemplateSetAddFootPauses: "process.v_template.set_add_foot_pauses",
      ...
      vTemplateSetSpoolChangePause: "process.v_template.set_spool_change_pause",
      ...
      uTemplateSetSpoolChangePause: "process.u_template.set_spool_change_pause",
      ...
      manualCalibrationSetSpoolChangePause: "process.manual_calibration.set_spool_change_pause",
