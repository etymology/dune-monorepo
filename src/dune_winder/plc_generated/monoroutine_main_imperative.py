...
def Monoroutine_main(ctx):
  ...
  while _pc < 764:
    if _pc == 0:
      ...
      set_tag('MACHINE_SW_STAT[25]', bool((tag('DUNEW2PLC2:1:I.Pt00Data')) and (tag('DUNEW2PLC2:1:I.Pt01Data'))))
      _pc = 21
      continue
    elif _pc == 21:
      # rung 21
      ...
      set_tag('Z_RETRACTED', bool((_branch_21) and (tag('Z_RETRACTED_1B')) and (tag('Z_RETRACTED_2B'))))
      _pc = 29
      continue
    elif _pc == 29:
      # rung 29
      # XIC Z_EOT XIC PLUS_Y_EOT XIC MINUS_Y_EOT XIC PLUS_X_EOT XIC MINUS_X_EOT OTE ALL_EOT_GOOD
      set_tag('ALL_EOT_GOOD', bool((tag('Z_EOT')) and (tag('PLUS_Y_EOT')) and (tag('MINUS_Y_EOT')) and (tag('PLUS_X_EOT')) and (tag('MINUS_X_EOT'))))
      _pc = 30
      continue
    elif _pc == 30:
      # rung 30
      # LIM 80 Y_axis.ActualPosition 450 OTE support_collision_window_bttm
      set_tag('support_collision_window_bttm', bool(80 <= tag('Y_axis.ActualPosition') <= 450))
      _pc = 31
      continue
    elif _pc == 31:
      # rung 31
      # LIM 1050 Y_axis.ActualPosition 1550 OTE support_collision_window_mid
      set_tag('support_collision_window_mid', bool(1050 <= tag('Y_axis.ActualPosition') <= 1550))
      _pc = 32
      continue
    elif _pc == 32:
      # rung 32
      # LIM 2200 Y_axis.ActualPosition 2650 OTE support_collision_window_top
      set_tag('support_collision_window_top', bool(2200 <= tag('Y_axis.ActualPosition') <= 2650))
      _pc = 33
      continue
    elif _pc == 33:
      # rung 33
      ...
      set_tag('Local:3:O.Pt15.Data', bool((tag('blink_on.TT')) and (tag('T01.TT'))))
      _pc = 39
      continue
    elif _pc == 39:
      # rung 39
      ...
      # rung 59
      # CPT v_xyz SQR(X_axis.ActualVelocity*X_axis.ActualVelocity+Y_axis.ActualVelocity*Y_axis.ActualVelocity)+SQR(Z_axis.ActualVelocity*Z_axis.ActualVelocity)
      set_tag('v_xyz', formula('SQR(X_axis.ActualVelocity*X_axis.ActualVelocity+Y_axis.ActualVelocity*Y_axis.ActualVelocity)+SQR(Z_axis.ActualVelocity*Z_axis.ActualVelocity)'))
      _pc = 60
      continue
    elif _pc == 60:
      # rung 60
      # CPT v_xy SQR(X_axis.ActualVelocity*X_axis.ActualVelocity+Y_axis.ActualVelocity*Y_axis.ActualVelocity)
      set_tag('v_xy', formula('SQR(X_axis.ActualVelocity*X_axis.ActualVelocity+Y_axis.ActualVelocity*Y_axis.ActualVelocity)'))
      _pc = 61
      continue
    elif _pc == 61:
      # rung 61
      ...
      if tag('v_xy') != 0:
        set_tag('accel_xy', formula('(X_axis.ActualVelocity*X_axis.CommandAcceleration+Y_axis.ActualVelocity*Y_axis.CommandAcceleration)/v_xy'))
      _pc = 62
      continue
    elif _pc == 62:
      # rung 62
      ...
      _branch_56 = bool((not tag('Z_STAGE_LATCHED')) and (not tag('Z_FIXED_LATCHED')))
      ...
      set_tag('Enable_tension_motor', bool((tag('TENSION_ON_SWITCH')) and (not tag('Safety_Tripped_S')) and (_branch_65)))
      _pc = 70
      continue
    elif _pc == 70:
      # rung 70
      ...
      # rung 72
      # CPT tension 2.26*tension_tag-0.503*tension_tag*tension_tag+0.0694*tension_tag*tension_tag*tension_tag-0.00314*tension_tag*tension_tag*tension_tag*tension_tag
      set_tag('tension', formula('2.26*tension_tag-0.503*tension_tag*tension_tag+0.0694*tension_tag*tension_tag*tension_tag-0.00314*tension_tag*tension_tag*tension_tag*tension_tag'))
      _pc = 73
      continue
    elif _pc == 73:
      # rung 73
      ...
      _branch_98 = bool((tag('tension_on_switch_delay_on_start.TT')) and (tag('tension_motor_cv') < tag('neutral_cv')))
      ...
      _branch_107 = _branch_88 or _branch_90 or _branch_92 or _branch_101 or _branch_103 or _branch_105
      _pc = 75
      continue
    elif _pc == 75:
      # rung 75
      ...
      # rung 76
      # CPT current_command cv_to_electrocraft*(current_command_high-current_command_low)/pid_cv_high_limit+current_command_low
      set_tag('current_command', formula('cv_to_electrocraft*(current_command_high-current_command_low)/pid_cv_high_limit+current_command_low'))
      _pc = 77
      continue
    elif _pc == 77:
      # rung 77
      # CPT neutral_cv -current_command_low/((current_command_high-current_command_low)/(pid_cv_high_limit-pid_cv_low_limit))
      set_tag('neutral_cv', formula('-current_command_low/((current_command_high-current_command_low)/(pid_cv_high_limit-pid_cv_low_limit))'))
      _pc = 78
      continue
    elif _pc == 78:
      # rung 78
      ...
      TON(
        ...
        preset=100,
        accum=0,
        rung_in=formula('ABS(tension-tension_setpoint)<tension_stable_tolerance'),
      )
      _pc = 79
      continue
    elif _pc == 79:
      ...
      set_tag('Local:3:O.Pt15.Data', bool((tag('tension') > tag('max_tolerable_tension')) and (tag('TENSION_ON_SWITCH'))))
      TON(
        timer_tag='overtension_timer',
        preset=10,
        accum=0,
        rung_in=(tag('tension') > tag('max_tolerable_tension')) and (tag('TENSION_ON_SWITCH')),
      )
      _pc = 80
      continue
    elif _pc == 80:
      ...
      set_tag('PTS_clear_tension_fault_oneshot', bool((not tag('TENSION_ON_SWITCH')) and (tag('PTS_tension_switch_transition_oneshot_storage'))))
      _pc = 83
      continue
    elif _pc == 83:
      # rung 83
      ...
      set_tag('INIT_OutBit[0]', bool((tag('TIMER.DN')) and (not tag('INIT_SetBit[0]'))))
      _pc = 88
      continue
    elif _pc == 88:
      # rung 88
      ...
      set_tag('INIT_OutBit[1]', bool((tag('INIT_z_axis_fault_reset_status.DN')) and (not tag('INIT_SetBit[1]'))))
      _pc = 95
      continue
    elif _pc == 95:
      # rung 95
      ...
      set_tag('trigger_axes_ob', bool((tag('STATE1_IND')) and (not tag('trigger_axes_sb'))))
      _pc = 100
      continue
    elif _pc == 100:
      # rung 100
      ...
      set_tag('RS1_OutBit[0]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=1')) and (not tag('RS1_SetBit[0]'))))
      _pc = 105
      continue
    elif _pc == 105:
      # rung 105
      ...
      set_tag('RS1_OutBit[1]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=2')) and (not tag('RS1_SetBit[1]'))))
      _pc = 109
      continue
    elif _pc == 109:
      # rung 109
      ...
      set_tag('RS1_OutBit[2]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=3')) and (not tag('RS1_SetBit[2]'))))
      _pc = 113
      continue
    elif _pc == 113:
      # rung 113
      ...
      set_tag('RS1_OutBit[3]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=4')) and (not tag('RS1_SetBit[3]'))))
      _pc = 117
      continue
    elif _pc == 117:
      # rung 117
      ...
      set_tag('RS1_OutBit[4]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=5')) and (not tag('RS1_SetBit[4]'))))
      _pc = 121
      continue
    elif _pc == 121:
      # rung 121
      ...
      set_tag('RS1_OutBit[5]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=6')) and (not tag('RS1_SetBit[5]'))))
      _pc = 125
      continue
    elif _pc == 125:
      # rung 125
      ...
      set_tag('RS1_OutBit[6]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=7')) and (not tag('RS1_SetBit[6]'))))
      _pc = 129
      continue
    elif _pc == 129:
      # rung 129
      ...
      set_tag('RS1_OutBit[7]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=8')) and (not tag('RS1_SetBit[7]'))))
      _pc = 133
      continue
    elif _pc == 133:
      # rung 133
      ...
      set_tag('RS1_OutBit[8]', bool((tag('STATE1_IND')) and (formula('MOVE_TYPE=11')) and (not tag('RS1_SetBit[8]'))))
      _pc = 137
      continue
    elif _pc == 137:
      # rung 137
      ...
      set_tag('STATE3_IND', bool((not tag('main_xy_move.IP')) and (formula('STATE=3')) and (_branch_164) and (tag('Z_RETRACTED')) and (_branch_176)))
      ...
      set_tag('MXY_state3_entry_oneshot', bool((tag('STATE3_IND')) and (not tag('MXY_state3_entry_oneshot_storage'))))
      _pc = 143
      continue
    elif _pc == 143:
      # rung 143
      ...
      set_tag('MXY_axes_servo_ready_oneshot', bool((tag('MXY_x_axis_servo_on_status.DN')) and (tag('MXY_y_axis_servo_on_status.DN')) and (not tag('MXY_axes_servo_ready_oneshot_storage'))))
      _pc = 148
      continue
    elif _pc == 148:
      # rung 148
      ...
      _branch_202 = bool((tag('MXY_x_axis_servo_on_status.DN')) and (tag('MXY_y_axis_servo_on_status.DN')) and (tag('MXY_state3_entry_oneshot')))
      _branch_204 = _branch_200 or _branch_202
      set_tag('trigger_xy_move', bool((_branch_204) and (not tag('MXY_trigger_xy_move_oneshot_storage'))))
      _pc = 151
      continue
    elif _pc == 151:
      # rung 151
      ...
      _branch_207 = bool((tag('MXY_x_axis_servo_on_status.DN')) and (tag('MXY_y_axis_servo_on_status.DN')) and (tag('MXY_state3_entry_oneshot')))
      ...
      set_tag('xy_dist_to_target', formula('SQR(x_dist_to_target*x_dist_to_target+y_dist_to_target*y_dist_to_target)'))
      _pc = 156
      continue
    elif _pc == 156:
      # rung 156
      ...
      set_tag('stopping_distance', formula('(accel_xy+gamma)*(accel_xy+gamma)*(accel_xy+gamma)/(6*J*J)'))
      _pc = 157
      continue
    elif _pc == 157:
      # rung 157
      # CMP "xy_dist_to_target<stopping_distance*1" OTE near_ending
      set_tag('near_ending', bool(formula('xy_dist_to_target<stopping_distance*1')))
      _pc = 158
      continue
    elif _pc == 158:
      # rung 158
      ...
      if formula('STATE=3'):
        set_tag('stopping_ratio', formula('stopping_distance/xy_dist_to_target'))
      _pc = 159
      continue
    elif _pc == 159:
      # rung 159
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('TENSION_CONTROL_OK')) and (tag('speed_regulator_switch')) and (tag('trigger_xy_move')),
      )
      _pc = 160
      continue
    elif _pc == 160:
      ...
      TON(
        ...
        preset=1,
        accum=0,
        rung_in=(tag('TENSION_CONTROL_OK')) and (tag('speed_regulator_switch')) and (not tag('regulator_loop_timer.DN')),
      )
      _pc = 162
      continue
    elif _pc == 162:
      ...
      TON(
        ...
        preset=1,
        accum=0,
        rung_in=(tag('TENSION_CONTROL_OK')) and (tag('speed_regulator_switch')) and (not tag('xy_d_timer.DN')),
      )
      _pc = 163
      continue
    elif _pc == 163:
      ...
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('xy_d_timer.DN'):
            set_tag('d_raw', formula('xy_kd*(xy_error-xy_error_prev)/xy_d_dt*100'))
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('xy_d_timer.DN'):
            set_tag('xy_d_term', formula('xy_d_alpha*d_raw+(1-xy_d_alpha)*xy_d_term_prev'))
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('xy_d_timer.DN'):
      ...
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('regulator_loop_timer.DN'):
            if _branch_236:
              if _branch_241:
                set_tag('xy_i_term', formula('xy_i_term+(xy_ki*xy_error*xy_dt/1000)'))
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('regulator_loop_timer.DN'):
            if _branch_236:
      ...
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('regulator_loop_timer.DN'):
            set_tag('regulated_speed', formula('xy_default_speed+xy_p_term+xy_i_term+xy_d_term'))
      if tag('TENSION_CONTROL_OK'):
        if tag('speed_regulator_switch'):
          if tag('regulator_loop_timer.DN'):
      ...
      _branch_254 = bool((tag('TENSION_CONTROL_OK')) and (not tag('speed_regulator_switch')))
      ...
      set_tag('MXY_speed_regulator_disabled_oneshot', bool((not tag('speed_regulator_switch')) and (tag('MXY_speed_regulator_disabled_oneshot_storage'))))
      _pc = 170
      continue
    elif _pc == 170:
      # rung 170
      ...
      set_tag('MXY_xy_move_done_or_fault_oneshot', bool((_branch_261) and (_branch_266) and (not tag('MXY_xy_move_done_or_fault_oneshot_storage'))))
      _pc = 174
      continue
    elif _pc == 174:
      # rung 174
      ...
      set_tag('MXY_eot_triggered', bool((tag('main_xy_move.IP')) and (not tag('ALL_EOT_GOOD')) and (not tag('MXY_eot_triggered_oneshot_storage'))))
      _pc = 178
      continue
    elif _pc == 178:
      # rung 178
      ...
      _branch_297 = bool((tag('support_collision_window_bttm')) and (not tag('FRAME_LOC_HD_BTM')))
      _branch_299 = bool((tag('support_collision_window_mid')) and (not tag('FRAME_LOC_HD_MID')))
      _branch_301 = bool((tag('support_collision_window_top')) and (not tag('FRAME_LOC_HD_TOP')))
      _branch_303 = _branch_297 or _branch_299 or _branch_301
      _branch_304 = bool((400 <= tag('X_axis.ActualPosition') <= 500) and (_branch_303))
      _branch_306 = bool((tag('support_collision_window_bttm')) and (not tag('FRAME_LOC_FT_BTM')))
      _branch_308 = bool((tag('support_collision_window_mid')) and (not tag('FRAME_LOC_FT_MID')))
      _branch_310 = bool((tag('support_collision_window_top')) and (not tag('FRAME_LOC_FT_TOP')))
      _branch_312 = _branch_306 or _branch_308 or _branch_310
      _branch_313 = bool((7100 <= tag('X_axis.ActualPosition') <= 7200) and (_branch_312))
      _branch_315 = bool((not tag('support_collision_window_bttm')) and (not tag('support_collision_window_mid')) and (not tag('support_collision_window_top')))
      ...
      set_tag('MASTER_Z_GO', bool((tag('no_latch_collision')) and (tag('no_supports_collision')) and (tag('no_apa_collision'))))
      _pc = 187
      continue
    elif _pc == 187:
      # rung 187
      ...
      set_tag('STATE5_IND', bool((formula('STATE=5')) and (tag('MASTER_Z_GO')) and (_branch_331)))
      _pc = 192
      continue
    elif _pc == 192:
      # rung 192
      ...
      MAM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('STATE5_IND')) and (tag('Z_axis.DriveEnableStatus')) and (not tag('Z_FIXED_LATCHED')),
      )
      _pc = 194
      continue
    elif _pc == 194:
      ...
      MAM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('STATE5_IND')) and (tag('Z_axis.DriveEnableStatus')) and (tag('Z_FIXED_LATCHED')),
      )
      _pc = 195
      continue
    elif _pc == 195:
      ...
      set_tag('z_move_success', bool((formula('STATE=5')) and (formula('ABS(Z_axis.ActualPosition-Z_POSITION)<0.1'))))
      _pc = 199
      continue
    elif _pc == 199:
      # rung 199
      ...
      set_tag('Z_STAGE_UNLATCHED', bool((tag('LATCH_ACTUATOR_TOP')) and (not tag('LATCH_ACTUATOR_MID'))))
      _pc = 203
      continue
    elif _pc == 203:
      # rung 203
      ...
      set_tag('Z_OK_TO_ENGAGE', bool((tag('LATCH_ACTUATOR_TOP')) and (tag('LATCH_ACTUATOR_MID')) and (_branch_336)))
      _pc = 204
      continue
    elif _pc == 204:
      # rung 204
      ...
      set_tag('Z_SAFE_TO_WITHDRAW', bool((tag('Z_FIXED_LATCHED')) and (tag('Delay_Fixed_Latched.DN'))))
      ...
      set_tag('ENABLE_ACTUATOR', bool((tag('Z_STAGE_PRESENT')) and (tag('Z_FIXED_PRESENT')) and (tag('Z_EXTENDED'))))
      _pc = 208
      continue
    elif _pc == 208:
      # rung 208
      ...
      set_tag('LAT_state6_enable_missing_oneshot', bool((tag('STATE6_IND')) and (not tag('ENABLE_ACTUATOR')) and (not tag('LAT_state6_enable_missing_oneshot_storage'))))
      _pc = 210
      continue
    elif _pc == 210:
      # rung 210
      ...
      set_tag('LAT_state6_enable_present_oneshot', bool((tag('STATE6_IND')) and (tag('ENABLE_ACTUATOR')) and (not tag('LAT_state6_enable_present_oneshot_storage'))))
      _pc = 214
      continue
    elif _pc == 214:
      # rung 214
      ...
      TON(
        ...
        preset=10,
        accum=0,
        rung_in=(tag('LAT_state6_enable_present_oneshot_storage')) and (not tag('Latching_pulse_interval.DN')),
      )
      _pc = 219
      continue
    elif _pc == 219:
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(not tag('LAT_latching_pulse_interval_holdoff_storage')) and (tag('Latching_pulse_duration.DN')),
      )
      _pc = 220
      continue
    elif _pc == 220:
      ...
      set_tag('LAT_state7_entry_oneshot', bool((tag('STATE7_IND')) and (not tag('LAT_state7_entry_oneshot_storage'))))
      _pc = 222
      continue
    elif _pc == 222:
      # rung 222
      ...
      TON(
        ...
        preset=500,
        accum=0,
        rung_in=(tag('LAT_state7_entry_oneshot_storage')) and (not tag('HomeCounter.DN')) and (not tag('HomeTimer2.TT')),
      )
      _pc = 226
      continue
    elif _pc == 226:
      ...
      TON(
        ...
        preset=500,
        accum=0,
        rung_in=(tag('LAT_state7_entry_oneshot_storage')) and (not tag('HomeCounter.DN')) and (not tag('HomeTimer1.TT')),
      )
      _pc = 227
      continue
    elif _pc == 227:
      ...
      set_tag('Local:3:O.Pt02.Data', bool((tag('HomeCounter.DN')) and (tag('sometag'))))
      _pc = 229
      continue
    elif _pc == 229:
      # rung 229
      # XIC HomeCounter.DN XIO LAT_home_counter_done_oneshot_storage OTE LAT_home_counter_done_oneshot
      set_tag('LAT_home_counter_done_oneshot', bool((tag('HomeCounter.DN')) and (not tag('LAT_home_counter_done_oneshot_storage'))))
      _pc = 230
      continue
    elif _pc == 230:
      # rung 230
      ...
      set_tag('LAT_latch_actuator_homed_oneshot', bool((tag('LATCH_ACTUATOR_HOMED')) and (not tag('LAT_latch_actuator_homed_oneshot_storage'))))
      _pc = 236
      continue
    elif _pc == 236:
      # rung 236
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_latch_actuator_homed_oneshot_storage')) and (not tag('LatchCounter3.DN')) and (not tag('LatchTimer6.TT')),
      )
      _pc = 240
      continue
    elif _pc == 240:
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_latch_actuator_homed_oneshot_storage')) and (not tag('LatchCounter3.DN')) and (not tag('LatchTimer5.TT')),
      )
      _pc = 241
      continue
    elif _pc == 241:
      ...
      set_tag('LAT_home_verify_done_oneshot', bool((tag('LatchCounter3.DN')) and (not tag('LAT_home_verify_done_oneshot_storage'))))
      _pc = 243
      continue
    elif _pc == 243:
      # rung 243
      ...
      set_tag('Local:3:O.Pt02.Data', bool((tag('STATE8_IND')) and (tag('sometag'))))
      _pc = 248
      continue
    elif _pc == 248:
      # rung 248
      ...
      set_tag('LAT_state8_entry_oneshot', bool((tag('STATE8_IND')) and (not tag('LAT_state8_entry_oneshot_storage'))))
      _pc = 250
      continue
    elif _pc == 250:
      # rung 250
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_state8_entry_oneshot_storage')) and (not tag('LatchCounter2.DN')) and (not tag('LatchTimer4.TT')),
      )
      _pc = 255
      continue
    elif _pc == 255:
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_state8_entry_oneshot_storage')) and (not tag('LatchCounter2.DN')) and (not tag('LatchTimer3.TT')),
      )
      _pc = 256
      continue
    elif _pc == 256:
      ...
      set_tag('unsafe_to_latch', bool((tag('Z_STAGE_PRESENT')) and (not tag('Z_FIXED_PRESENT'))))
      _pc = 261
      continue
    elif _pc == 261:
      # rung 261
      ...
      set_tag('LAT_latching_timeout_monitor_oneshot', bool((_branch_384) and (not tag('LAT_latching_timeout_monitor_oneshot_storage'))))
      _pc = 264
      continue
    elif _pc == 264:
      # rung 264
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_latching_timeout_monitor_oneshot_storage')) and (not tag('LatchingTimeoutCounter.DN')) and (not tag('TimeoutTimer2.TT')),
      )
      _pc = 268
      continue
    elif _pc == 268:
      ...
      TON(
        ...
        preset=250,
        accum=0,
        rung_in=(tag('LAT_latching_timeout_monitor_oneshot_storage')) and (not tag('LatchingTimeoutCounter.DN')) and (not tag('TimeoutTimer1.TT')),
      )
      _pc = 269
      continue
    elif _pc == 269:
      ...
      set_tag('LAT_latching_timeout_done_oneshot', bool((tag('LatchingTimeoutCounter.DN')) and (not tag('LAT_latching_timeout_done_oneshot_storage'))))
      _pc = 271
      continue
    elif _pc == 271:
      # rung 271
      ...
      set_tag('US9_state9_entry_oneshot', bool((tag('STATE9_IND')) and (not tag('US9_state9_entry_oneshot_storage'))))
      _pc = 276
      continue
    elif _pc == 276:
      # rung 276
      ...
      set_tag('US9_x_unservo_done_oneshot', bool((tag('US9_x_axis_unservo_status.DN')) and (not tag('US9_x_unservo_done_oneshot_storage'))))
      _pc = 282
      continue
    elif _pc == 282:
      # rung 282
      ...
      set_tag('US9_y_unservo_done_oneshot', bool((tag('US9_y_axis_unservo_status.DN')) and (not tag('US9_y_unservo_done_oneshot_storage'))))
      _pc = 286
      continue
    elif _pc == 286:
      # rung 286
      ...
      set_tag('US9_z_unservo_done_oneshot', bool((tag('US9_z_axis_unservo_status.DN')) and (not tag('US9_z_unservo_done_oneshot_storage'))))
      _pc = 290
      continue
    elif _pc == 290:
      # rung 290
      ...
      set_tag('ERR10_state10_entry_oneshot', bool((tag('STATE10_IND')) and (not tag('ERR10_state10_entry_oneshot_storage'))))
      _pc = 296
      continue
    elif _pc == 296:
      # rung 296
      ...
      set_tag('ERR10_motion_stop_done_oneshot', bool((tag('ERR10_xy_group_stop_status.PC')) and (tag('ERR10_z_axis_stop_status.PC')) and (not tag('ERR10_motion_stop_done_oneshot_storage'))))
      _pc = 301
      continue
    elif _pc == 301:
      # rung 301
      ...
      set_tag('ERR10_servo_off_done_oneshot', bool((tag('ERR10_x_axis_unservo_status.DN')) and (tag('ERR10_y_axis_unservo_status.DN')) and (tag('ERR10_z_axis_unservo_status.DN')) and (formula('MOVE_TYPE=0')) and (not tag('ERR10_servo_off_done_oneshot_storage'))))
      _pc = 307
      continue
    elif _pc == 307:
      # rung 307
      ...
      set_tag('EOT11_state11_entry_oneshot', bool((tag('STATE11_IND')) and (not tag('EOT11_state11_entry_oneshot_storage'))))
      _pc = 315
      continue
    elif _pc == 315:
      # rung 315
      ...
      set_tag('EOT11_axes_stopped_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (not tag('EOT11_axes_stopped_oneshot_storage'))))
      _pc = 319
      continue
    elif _pc == 319:
      # rung 319
      ...
      set_tag('EOT11_minus_x_recovery_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (tag('EOT11_x_axis_servo_on_status.DN')) and (tag('EOT11_y_axis_servo_on_status.DN')) and (tag('EOT11_z_axis_servo_on_status.DN')) and (not tag('PLUS_X_EOT')) and (tag('MINUS_X_EOT')) and (not tag('EOT11_minus_x_recovery_move_status.IP')) and (not tag('EOT11_minus_x_recovery_oneshot_storage'))))
      _pc = 328
      continue
    elif _pc == 328:
      # rung 328
            ...
            if tag('EOT11_y_axis_servo_on_status.DN'):
              if tag('EOT11_z_axis_servo_on_status.DN'):
                if not tag('PLUS_X_EOT'):
                  if tag('MINUS_X_EOT'):
                    if not tag('EOT11_minus_x_recovery_move_status.IP'):
                      set_tag('EOT11_minus_x_recovery_oneshot_storage', True)
      _pc = 329
      continue
    elif _pc == 329:
      # rung 329
      ...
      _branch_430 = _branch_414 or _branch_416 or _branch_418 or _branch_420 or _branch_422 or _branch_424 or _branch_426 or _branch_428
      if _branch_430:
      ...
      set_tag('EOT11_plus_x_recovery_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (tag('EOT11_x_axis_servo_on_status.DN')) and (tag('EOT11_y_axis_servo_on_status.DN')) and (tag('EOT11_z_axis_servo_on_status.DN')) and (not tag('MINUS_X_EOT')) and (tag('PLUS_X_EOT')) and (not tag('EOT11_plus_x_recovery_move_status.IP')) and (not tag('EOT11_plus_x_recovery_oneshot_storage'))))
      _pc = 332
      continue
    elif _pc == 332:
      # rung 332
            ...
            if tag('EOT11_y_axis_servo_on_status.DN'):
              if tag('EOT11_z_axis_servo_on_status.DN'):
                if not tag('MINUS_X_EOT'):
                  if tag('PLUS_X_EOT'):
                    if not tag('EOT11_plus_x_recovery_move_status.IP'):
                      set_tag('EOT11_plus_x_recovery_oneshot_storage', True)
      _pc = 333
      continue
    elif _pc == 333:
      # rung 333
      ...
      _branch_447 = _branch_431 or _branch_433 or _branch_435 or _branch_437 or _branch_439 or _branch_441 or _branch_443 or _branch_445
      if _branch_447:
      ...
      set_tag('EOT11_minus_y_recovery_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (tag('EOT11_x_axis_servo_on_status.DN')) and (tag('EOT11_y_axis_servo_on_status.DN')) and (tag('EOT11_z_axis_servo_on_status.DN')) and (not tag('PLUS_Y_EOT')) and (tag('MINUS_Y_EOT')) and (not tag('EOT11_minus_y_recovery_move_status.IP')) and (not tag('EOT11_minus_y_recovery_oneshot_storage'))))
      _pc = 336
      continue
    elif _pc == 336:
      # rung 336
            ...
            if tag('EOT11_y_axis_servo_on_status.DN'):
              if tag('EOT11_z_axis_servo_on_status.DN'):
                if not tag('PLUS_Y_EOT'):
                  if tag('MINUS_Y_EOT'):
                    if not tag('EOT11_minus_y_recovery_move_status.IP'):
                      set_tag('EOT11_minus_y_recovery_oneshot_storage', True)
      _pc = 337
      continue
    elif _pc == 337:
      # rung 337
      ...
      _branch_464 = _branch_448 or _branch_450 or _branch_452 or _branch_454 or _branch_456 or _branch_458 or _branch_460 or _branch_462
      if _branch_464:
      ...
      set_tag('EOT11_plus_y_recovery_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (tag('EOT11_x_axis_servo_on_status.DN')) and (tag('EOT11_y_axis_servo_on_status.DN')) and (tag('EOT11_z_axis_servo_on_status.DN')) and (not tag('MINUS_Y_EOT')) and (tag('PLUS_Y_EOT')) and (not tag('EOT11_plus_y_recovery_move_status.IP')) and (not tag('EOT11_plus_y_recovery_oneshot_storage'))))
      _pc = 340
      continue
    elif _pc == 340:
      # rung 340
            ...
            if tag('EOT11_y_axis_servo_on_status.DN'):
              if tag('EOT11_z_axis_servo_on_status.DN'):
                if not tag('MINUS_Y_EOT'):
                  if tag('PLUS_Y_EOT'):
                    if not tag('EOT11_plus_y_recovery_move_status.IP'):
                      set_tag('EOT11_plus_y_recovery_oneshot_storage', True)
      _pc = 341
      continue
    elif _pc == 341:
      # rung 341
      ...
      _branch_481 = _branch_465 or _branch_467 or _branch_469 or _branch_471 or _branch_473 or _branch_475 or _branch_477 or _branch_479
      if _branch_481:
      ...
      set_tag('EOT11_z_clearance_move_oneshot', bool((tag('STATE11_IND')) and (tag('EOT11_xy_group_stop_status.DN')) and (tag('EOT11_x_axis_servo_on_status.DN')) and (tag('EOT11_y_axis_servo_on_status.DN')) and (tag('EOT11_z_axis_servo_on_status.DN')) and (not tag('Z_EOT')) and (not tag('EOT11_z_clearance_move_status.IP')) and (not tag('EOT11_z_clearance_move_oneshot_storage'))))
      _pc = 344
      continue
    elif _pc == 344:
      # rung 344
              ...
              if tag('EOT11_z_axis_servo_on_status.DN'):
                if not tag('Z_EOT'):
                  if not tag('EOT11_z_clearance_move_status.IP'):
                    set_tag('EOT11_z_clearance_move_oneshot_storage', True)
      _pc = 345
      continue
    elif _pc == 345:
      # rung 345
      ...
      _branch_496 = _branch_482 or _branch_484 or _branch_486 or _branch_488 or _branch_490 or _branch_492 or _branch_494
      if _branch_496:
      ...
      set_tag('EOT11_all_eot_good_oneshot', bool((tag('ALL_EOT_GOOD')) and (not tag('EOT11_z_clearance_move_status.IP')) and (not tag('EOT11_all_eot_good_oneshot_storage'))))
      _pc = 348
      continue
    elif _pc == 348:
      # rung 348
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('STATE12_IND')) and (tag('Y_XFER_OK')) and (not tag('xz_main_move.IP')),
      )
      _pc = 359
      continue
    elif _pc == 359:
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('YZ_STATE13_IND')) and (tag('X_XFER_OK')) and (not tag('yz_main_move.IP')),
      )
      _pc = 366
      continue
    elif _pc == 366:
      ...
      set_tag('hmi_stop_entry_ob', bool((tag('STATE14_IND')) and (not tag('hmi_stop_entry_sb'))))
      _pc = 372
      continue
    elif _pc == 372:
      # rung 372
      ...
      set_tag('SegValidLine', bool((tag('EnqueueReq')) and (tag('IncomingSeg.Valid')) and (tag('IncomingSeg.SegType') == 1) and (tag('IncomingSeg.Speed') > 0.0) and (tag('IncomingSeg.Accel') > 0.0) and (tag('IncomingSeg.Decel') > 0.0) and (tag('IncomingSeg.TermType') >= 0) and (tag('IncomingSeg.TermType') <= 6)))
      _pc = 391
      continue
    elif _pc == 391:
      # rung 391
      ...
      set_tag('SegValidArc', bool((tag('EnqueueReq')) and (tag('IncomingSeg.Valid')) and (tag('IncomingSeg.SegType') == 2) and (tag('IncomingSeg.Speed') > 0.0) and (tag('IncomingSeg.Accel') > 0.0) and (tag('IncomingSeg.Decel') > 0.0) and (tag('IncomingSeg.TermType') >= 0) and (tag('IncomingSeg.TermType') <= 6) and (tag('IncomingSeg.CircleType') >= 0) and (tag('IncomingSeg.CircleType') <= 3) and (tag('IncomingSeg.Direction') >= 0) and (tag('IncomingSeg.Direction') <= 3)))
      _pc = 392
      continue
    elif _pc == 392:
      # rung 392
      ...
      FFL(
        ...
        length=32,
        position=0,
        rung_in=(tag('EnqueueReq')) and (tag('SegValid')) and (not tag('QueueFull')),
      )
      _pc = 394
      continue
    elif _pc == 394:
      ...
      _branch_571 = bool(tag('REALS[38]') < 3.4028235E+38)
      _branch_573 = bool(tag('REALS[39]') < 3.4028235E+38)
      ...
      # rung 462
      # CPT REALS[26] SQR(REALS[24]*REALS[24]+REALS[25]*REALS[25])
      set_tag('REALS[26]', formula('SQR(REALS[24]*REALS[24]+REALS[25]*REALS[25])'))
      _pc = 463
      continue
    elif _pc == 463:
      # rung 463
      ...
      # rung 474
      # CPT REALS[31] SQR(REALS[20]-REALS[29]*REALS[20]-REALS[29]+REALS[21]-REALS[30]*REALS[21]-REALS[30])
      set_tag('REALS[31]', formula('SQR(REALS[20]-REALS[29]*REALS[20]-REALS[29]+REALS[21]-REALS[30]*REALS[21]-REALS[30])'))
      _pc = 475
      continue
    elif _pc == 475:
      # rung 475
      # CPT REALS[32] SQR(SegQueue[idx_2].XY[0]-REALS[29]*SegQueue[idx_2].XY[0]-REALS[29]+SegQueue[idx_2].XY[1]-REALS[30]*SegQueue[idx_2].XY[1]-REALS[30])
      set_tag('REALS[32]', formula('SQR(SegQueue[idx_2].XY[0]-REALS[29]*SegQueue[idx_2].XY[0]-REALS[29]+SegQueue[idx_2].XY[1]-REALS[30]*SegQueue[idx_2].XY[1]-REALS[30])'))
      _pc = 476
      continue
    elif _pc == 476:
      # rung 476
      ...
      if tag('REALS[913]') < 0.0:
        if tag('REALS[912]') >= 0.0:
          set_tag('REALS[33]', formula('ATN(REALS[912]/REALS[913])+3.14159265358979'))
      if tag('REALS[913]') < 0.0:
        if tag('REALS[912]') >= 0.0:
          _pc = 486
          continue
      ...
      if tag('REALS[915]') < 0.0:
        if tag('REALS[914]') >= 0.0:
          set_tag('REALS[34]', formula('ATN(REALS[914]/REALS[915])+3.14159265358979'))
      if tag('REALS[915]') < 0.0:
        if tag('REALS[914]') >= 0.0:
          _pc = 494
          continue
      ...
      set_tag('REALS[902]', formula('REALS[4]-0.5*3.14159265358979/3.14159265358979'))
      _pc = 536
      continue
    elif _pc == 536:
      # rung 536
      ...
      # rung 541
      # CPT REALS[904] REALS[5]-0.5*3.14159265358979/3.14159265358979
      set_tag('REALS[904]', formula('REALS[5]-0.5*3.14159265358979/3.14159265358979'))
      _pc = 542
      continue
    elif _pc == 542:
      # rung 542
      ...
      # rung 599
      # MOV 3.4028235E+38 REALS[47]
      set_tag('REALS[47]', 3.4028235E+38)
      _pc = 600
      continue
    elif _pc == 600:
      # rung 600
      ...
      # rung 603
      # MOV 3.4028235E+38 REALS[48]
      set_tag('REALS[48]', 3.4028235E+38)
      _pc = 604
      continue
    elif _pc == 604:
      # rung 604
      ...
      _pulse_596 = ONS(
        ...
        rung_in=(tag('StartQueuedPath')) and (not tag('CurIssued')) and (not tag('QueueFault')) and (tag('QueueCtl.POS') >= 1),
      )
      if _pulse_596:
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('IssueCurPulse')) and (tag('UseAasCurrent')) and (tag('CmdA_SegType') == 1),
      )
      _pc = 665
      continue
    elif _pc == 665:
      ...
      MCCM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('IssueCurPulse')) and (tag('UseAasCurrent')) and (tag('CmdA_SegType') == 2),
      )
      _pc = 666
      continue
    elif _pc == 666:
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('IssueCurPulse')) and (not tag('UseAasCurrent')) and (tag('CmdB_SegType') == 1),
      )
      _pc = 667
      continue
    elif _pc == 667:
      ...
      MCCM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('IssueCurPulse')) and (not tag('UseAasCurrent')) and (tag('CmdB_SegType') == 2),
      )
      _pc = 668
      continue
    elif _pc == 668:
      ...
      _pulse_602 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (tag('UseAasCurrent')) and (tag('MoveA.IP')) and (not tag('X_Y.MovePendingStatus')) and (not tag('NextIssued')) and (not tag('QueueEmpty')) and (not tag('QueueFault')),
      )
      if _pulse_602:
      ...
      _pulse_603 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (not tag('UseAasCurrent')) and (tag('MoveB.IP')) and (not tag('X_Y.MovePendingStatus')) and (not tag('NextIssued')) and (not tag('QueueEmpty')) and (not tag('QueueFault')),
      )
      if _pulse_603:
        set_tag('LoadNextReq', True)
      _pc = 672
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('MQ_IssueNextPulse')) and (tag('UseAasCurrent')) and (tag('CmdB_SegType') == 1),
      )
      _pc = 711
      continue
    elif _pc == 711:
      ...
      MCCM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('MQ_IssueNextPulse')) and (tag('UseAasCurrent')) and (tag('CmdB_SegType') == 2),
      )
      _pc = 712
      continue
    elif _pc == 712:
      ...
      MCLM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('MQ_IssueNextPulse')) and (not tag('UseAasCurrent')) and (tag('CmdA_SegType') == 1),
      )
      _pc = 713
      continue
    elif _pc == 713:
      ...
      MCCM(
        ...
        event_distance=0,
        calculated_data=0,
        rung_in=(tag('MQ_IssueNextPulse')) and (not tag('UseAasCurrent')) and (tag('CmdA_SegType') == 2),
      )
      _pc = 714
      continue
    elif _pc == 714:
      ...
      _pulse_609 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (tag('NextIssued')) and (tag('UseAasCurrent')) and (not tag('X_Y.MovePendingStatus')) and (tag('MoveB.IP')),
      )
      if _pulse_609:
      ...
      _pulse_610 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (tag('NextIssued')) and (not tag('UseAasCurrent')) and (not tag('X_Y.MovePendingStatus')) and (tag('MoveA.IP')),
      )
      if _pulse_610:
        set_tag('RotateMoves', True)
      _pc = 718
      ...
      _pulse_611 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (not tag('NextIssued')) and (tag('UseAasCurrent')) and (not tag('X_Y.MovePendingStatus')) and (tag('MoveA.PC')),
      )
      if _pulse_611:
      ...
      _pulse_612 = ONS(
        ...
        rung_in=(tag('CurIssued')) and (not tag('NextIssued')) and (not tag('UseAasCurrent')) and (not tag('X_Y.MovePendingStatus')) and (tag('MoveB.PC')),
      )
      if _pulse_612:
        set_tag('CurIssued', False)
      _pc = 731
