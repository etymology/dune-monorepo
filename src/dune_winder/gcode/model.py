...
_OPCODE_SPECS = (
    ...
    OpcodeSpec(
        Opcode.PIN_CENTER, "PIN_CENTER", "pin_a,pin_b,axes", "Center between pins."
    ),
    OpcodeSpec(Opcode.CLIP, "CLIP", "none", "Clip XY to transfer area."),
    OpcodeSpec(
        Opcode.OFFSET, "OFFSET", "axis+delta...", "Relative coordinate offsets."
    ),
    OpcodeSpec(
        Opcode.HEAD_LOCATION, "HEAD_LOCATION", "location", "Head side/position."
    ),
    ...
    OpcodeSpec(
        Opcode.ANCHOR_POINT, "ANCHOR_POINT", "pin,orientation", "Set wire anchor."
    ),
    OpcodeSpec(
