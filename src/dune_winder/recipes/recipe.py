...
class Recipe:
    ...
    # ---------------------------------------------------------------------
    @staticmethod
    def writeGeneratedFile(
        fileName, description, bodyLines, archiveDirectory=None, parentHash=None
    ):
        ...
        with open(fileName, "w", encoding="utf-8") as outputFile:
            outputFile.write(
                Recipe._buildGeneratedHeader(
                    description, bodyHash, parentHash=parentHash
                )
            )
