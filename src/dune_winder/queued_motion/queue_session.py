...
class QueuedMotionSession:
    def __init__(
        ...
        *,
        ...
        self._port = (
            port
            if isinstance(port, QueuedMotionPortAdapter)
            else QueuedMotionPortAdapter(port)
        )
