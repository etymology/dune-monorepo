...
def calibration_absolute_location(calibration: LayerCalibration, pin_name: str) -> Location:
...
def normalize_layer_calibration_to_absolute(
  ...
  for pin_name in calibration.getPinNames():
    normalized.setPinLocation(pin_name, calibration_absolute_location(calibration, pin_name))
