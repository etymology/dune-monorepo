...
all_differences = pd.concat(pairwise_differences.values(), ignore_index=True).dropna()
global_min, global_max = all_differences.min(), all_differences.max()
bin_edges = np.linspace(global_min, global_max, 51)  # 50 bins
