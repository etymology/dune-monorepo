...
csvFile         = r'C:\Users\vbaker3\Desktop\Desktop\Tension_Data_Upload\X_layer_8.csv'
                                                            # Full path to the input data file (must be a string ending in '.csv')
apaLayer        = r'X'                                       # Wire layer (must be given as one of 'X','U', 'V' or 'G')
action_id       = r'6807e88e69d3216f6335122b'                # ID of the existing tension measurements action to be edited (get from DB)
replaced_wires  = (r'All wire segments are within specified tolerance.')
                                                            # Free-form string, additional description or commentary if desired
edtAction_comms = r'This is an existing single layer tension measurements action, edited via M2M'
                                                            # Free-form string, additional description or commentary if desired
