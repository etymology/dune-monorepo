...
class _FakeIO:
    def __init__(
        self,
        ready_states,
        axis_seeking_states=None,
        head_ready_states=None,
        head_transfer_active=False,
    ):
...
class ManualModeTests(unittest.TestCase):
    ...
    def test_plc_seek_returns_to_stop_when_plc_stays_ready_and_axes_never_report_busy(
        self,
    ):
        io = _FakeIO(
