...
def test_uv_layout_wire_segment_endpoints_and_wrap_orientation_match_shared_examples():
    ...
    assert u_layout.wire_segment_endpoints(1146, family="B") == ("B1596", "B1607")
    assert u_layout.wire_segment_endpoints(1146, family="A") == ("A1596", "A1607")
    assert u_layout.wire_segment_endpoints(1151, family="B") == ("B1601", "B1602")
    assert u_layout.wire_segment_endpoints(1151, family="A") == ("A1601", "A1602")
