...
from dune_tension.tensiometer import AudioAcquisitionConfig
...
def test_acquire_audio_with_tensiometer_config_does_not_trim_leading(
    monkeypatch,
) -> None:
    sample_rate = 100
    ...
    assert captured is not None
    assert captured.tolist() == list(range(20))
